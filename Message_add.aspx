<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Message_add.aspx.cs" Inherits="InnBooking.Message_add" %>
		...
		<div class="wrap-contact100">
			<form class="contact100-form validate-form">
				...
				<div class="wrap-input100 validate-input bg0 rs1-alert-validate" data-validate = "Please Type Your Message">
					<span class="label-input100">Message(如需上傳照片，請按下方瀏覽)</span>					
					<asp:TextBox ID="TextBox3" runat="server" Height="258px" TextMode="MultiLine" Width="750px"  class="input100" placeholder="Your message here..." ></asp:TextBox>
				</div>
                ...
                <asp:Label ID="Warm" runat="server" Text="" ForeColor="#006600" Font-Italic="True"></asp:Label>
			</form>
		</div>
	</div>
