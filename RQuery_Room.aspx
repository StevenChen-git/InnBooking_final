<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RQuery_Room.aspx.cs" Inherits="InnBooking.RQuery_Room" %>
...
<body>
   <form id="form1" runat="server">    
      ...
      <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            ...
            >
                   <a class="navbar-brand" > User:   <asp:Label ID="Label6" runat="server" Text="Label"></asp:Label></a> 
            <!-- Navbar-->
...
<div class="card mb-4">
             <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="查詢可預訂房型(價錢從低到高)" CssClass="btn-dark" />
            <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="查詢可預訂房型(價錢從高到低)" CssClass="btn-dark"/>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional" >
    ...
    <asp:AsyncPostBackTrigger ControlID="Timer1" EventName="Tick" />
        ...
        <ContentTemplate>
    <div class="card mb-4">
        <div class="card-header"><i class="fas fa-table mr-1"></i>Query Room List
        </div>
    ...
    <div class="card mb-4">
            <asp:Button ID="Button3" runat="server" OnClick="Button3_Click" CssClass="btn-secondary" Text="下一頁" />
