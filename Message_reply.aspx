<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Message_reply.aspx.cs" Inherits="InnBooking.Message_reply" %>
...
-->
				...
				<div class="wrap-input100 validate-input bg0 rs1-alert-validate" data-validate = "Please Type Your Message">
					...
					<asp:TextBox ID="Reply_messages" runat="server" Height="258px" TextMode="MultiLine" Width="750px" class="input100" placeholder="Your message here..."></asp:TextBox>
<!--					-->
				</div>
