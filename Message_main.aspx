<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Message_main.aspx.cs" Inherits="InnBooking.Message_main" %>
	...
	<div class="container-contact100">
		<div class="wrap-contact100">
				...
				<span class="contact100-form-title">
                    ...
                    <div class="wrap-input100 validate-input bg1" data-validate="">
						<span class="label-input100">照片: </span>
                        <asp:Image ID="Image1" runat="server" />
					</div>
					<div class="container-contact100-form-btn">
						<asp:Button ID="Replay" runat="server" OnClick="Button1_Click" Text="回應文章" class="contact100-form-btn"/> &nbsp&nbsp&nbsp
                        <asp:Button ID="BacktoMIndex" runat="server" Text="回到留言列表" class="contact100-form-btn" OnClick="BacktoMIndex_Click" CssClass="btn-dark"/>
					</div>
				<br /><br /><br />
				<div class="card mb-4">
